package com.jinxf.activitylifecycletest;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button startNButton = (Button) findViewById(R.id.start_normal_activity);
        Button startDButton = (Button) findViewById(R.id.start_dialog_activity);
